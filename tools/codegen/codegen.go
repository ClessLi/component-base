...
！！{{.FullName}} 系统(简称{{.SimpleName}})错误码列表，由 {{.BackQuote}}codegen -type=int -fullname "{{.FullName}}" -simplename "{{.SimpleName}}" -doc{{.BackQuote}} 命令生成，不要对此文件做任何更改。
## 功能说明
...
type TemplateInfo struct {
	BackQuote, FullName, SimpleName string
}
